...
export const AdminPaymentsList = () => {
  ...
  useEffect(()=>{
    ...
    editFormProps.form?.setFieldsValue({ user_id: createFormProps?.initialValues?.user?.id });
      ...
      <>        <List
        ...
        >
          ...
          <Table className="custom-table" {...tableProps} rowKey="id">
            ...
            <Table.Column dataIndex={"amount_subtotal"} title="SubTotal" />
            <Table.Column dataIndex={"amount_total"} title="Total" />
            <Table.Column dataIndex={"amount_discount"} title="Discount" />
...
<Modal {...editModalProps} title='Edit Location'> 
<Form
          {...editFormProps}
          layout='vertical'
          initialValues={{
